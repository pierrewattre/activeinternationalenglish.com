...
function twentyeleven_setup() {
	...
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'twentyeleven_header_image_width', 962 ) );
...
function my_multi_col($content) {
	$columns = explode('<hr />', $content);
	$i = 0;

  if (isset($columns[1])) {
    $return .= '<div class="entry-content twocol">'."\n";
    ...
    $return .= '</div>';
	  ...
	  $return .= '<div class="entry-content onecol">'."\n";
    $return .= $columns[0];
    $return .= '</div>';
	}

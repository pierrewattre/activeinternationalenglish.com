...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/OliJo_700.font.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/flashobject.js"></script>
<?php
...
<div id="page" class="hfeed">
  <script type="text/javascript">
    var fo = new FlashObject("<?php echo get_template_directory_uri(); ?>/flash/bg_v8.swf", "main_bg", "100%", "1450", "8", "");
